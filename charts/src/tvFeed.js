...
// Two concurrent TradingView WS sessions max, at least 400ms apart — tuned
// down from "unthrottled" (which reliably 429'd under multi-symbol,
// multi-timeframe load) rather than up from some tighter default; adjust
// via env if TradingView's actual limit turns out to be looser or tighter.
...
const fetchBars = (opts) => rateLimit(() => fetchBarsRaw(opts));
